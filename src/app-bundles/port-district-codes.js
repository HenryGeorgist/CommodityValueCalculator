...
export default{
    ...
    getReducer: () =>{
        const initialData = {
            portList: {
                ...
                "2782": "SAN BERNADINO INTL AIRPORT, CA",
                ...
                "3115": "SITKA, AK",
                "3126": "ANCHORAGE, AK",
                "3195": "FEDEX, ANCHORAGE, AK",
                "3196": "UPS COURIER HUB, ANCHORAGE, AK", 
                "3201": "HONOLULU, HI",
                "3202": "HILO, HI",
                "3203": "KAHULUI, HI",
                "3204": "NAWILIWILI-PORT ALLEN,HI",
                "3205": "HONOLULU INTL AIRPRT, HI",
                "3206": "KONA, HI",
                ...
                "5589": "MEACHAM INTL AIRPORT (FTW), TX",
               },
            districtList: {
                "01": "PORTLAND, ME",
                "02": "ST. ALBANS, VT",
        ...
        return (state = initialData, { type, payload}) => {
            switch(type){
                case 'LIST_DATA_SET_DISTRICTS':
                case 'LIST_DATA_SET_PORTS':
    ...
    selectDistrictList: (state)=>{
        return state.listData.districtList;
    },
    selectPortList: (state) =>{
        return state.listData.portList;
    }
}